...
#       --model mobilenetv2_width_multi13 --batch-size 128 --epochs 300 \
...
#python -m torch.distributed.launch --nproc_per_node=2 --use_env train.py \
#       --model mobilenetv2_width_multi13 --batch-size 128 --cache-dataset \
#       --resume ${output_dir}/model_300.pth --output-dir=${output_dir} --apex --test-only
